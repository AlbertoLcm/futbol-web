...
function FormUpdateEquipo() {
  ...
  const handleSubmit = async (values, { resetForm }) => {
    try {
      setSending(true);
      await instance.patch(`/equipos/update/${codigo}`, values, {
        headers: {
          "Content-Type": "multipart/form-data",
        },
      });
      successAlert("Éxito", "Equipo actualizado exitosamente");
      setImagen(null);
      resetForm();
  ...
  return (
    <Fragment>
      <form onSubmit={formik.handleSubmit}>
        ...
        <button type="submit" disabled={sending}>Actualizar Equipo</button>
      </form>
    </Fragment>
  );
}

export default FormUpdateEquipo;
