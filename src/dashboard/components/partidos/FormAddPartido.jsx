...
function FormAddPartido() {
  ...
  const handleSubmit = async (values, { resetForm }) => {
    try {
      await instance.post("/partidos/add", values);
      successAlert("Exito", "Partido creado correctamente");
      resetForm();
  ...
  const formik = useFormik({
    ...
    validationSchema: partidosSchemaCreate,
